      ...
      <div style="width: 100%;">
        <el-form :model="newdataform"
          ...
          <el-form-item label="通知ID"
                        prop="projectId"
                        style="width: 100%;">
            <el-input v-model="newdataform.projectId"
                      type="number"
          ...
          <el-form-item label="通知描述"
            ...
            <el-input type="textarea"
                      v-model="newdataform.description"></el-input>
          </el-form-item>
          ...
          <el-form-item label="通知内容"
            ...
            <mavon-editor ref="md"
                          @imgAdd="imgAdd"
                          @imgDel="imgDel"
                          v-model="newdataform.content"></mavon-editor>
          </el-form-item>
          ...
          <el-form-item label="上传缩略图"
                        v-if="!localimageurl">
            <el-upload action="http://81.70.56.45:8083/rotation/upload"
                       limit="1"
                       ref="upload2"
                       :headers="myHeaders"
                       list-type="picture-card"
          ...
          <el-form-item style="width: 100%;">
            <el-button type="primary"
                       @click="submitbefore()">立即修改</el-button>
    ...
    submitForm (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          console.log(that.newdataform);
          that.$axios.
            post("http://81.70.56.45:8083/menuItem/updateMenuDetail", {
              "id": that.newdataform.id,
              "menuId": that.newdataform.menuId,
              "projectId": that.newdataform.projectId,
              "content": that.newdataform.content,
              "title": that.newdataform.title,
              "description": that.newdataform.description,
              "name": that.newdataform.name
            }, {
              headers: {
