				...
				<el-form :model="newdataform.project" :rules="rules" ref="newdataform.project" label-width="100px"
					...
					<!-- <el-form-item label="上传校徽">
						<div v-if="(!iseditimg) && (!alreadyEditImg)" style="display: flex;justify-content: center;">
							<span>
								<el-image style="width: 100px; height: 100px" :src="newdataform.project.badgeUrl" fit="fill"></el-image>
							</span>
						...
						<div v-if="iseditimg" style="display: flex;justify-content: center;align-items: center;float: left;">
							<span style="margin-left: 5%;">
								<el-upload action="http://81.70.56.45:8082/project/upload" ref="upload2" list-type="picture-card"
									...
									:on-change="alreadyChangeImg" :before-upload="beforeAvatarUpload2">
