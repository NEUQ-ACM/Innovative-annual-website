			...
			<el-col :span="20">
				...
				<div style="width: 100%;margin-top: 2%;">
					<el-table :data="tableData" border v-loading="loading" style="width: 100%">
						...
						<el-table-column prop="title" label="论文名称" width="280">
						</el-table-column>
						<el-table-column prop="updateTime" label="论文修改时间">
						</el-table-column>
...
export default {
	...
	methods: {
		...
		deleteReset1() {
			this.current = 1
			this.$axios.get("http://81.70.56.45:8083/menuItem/getbyName/学术论文?currentPage=" + this.current).then((res) => {
				// console.log(res);
