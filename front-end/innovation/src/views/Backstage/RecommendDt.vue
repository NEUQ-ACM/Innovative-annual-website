      ...
      <div style="width: 100%">
        ...
        >
          ...
          <el-form-item label="项目描述" style="width: 100%" prop="description">
            <el-input
              type="textarea"
              v-model="newdataform.project.description"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="学生列表" style="width: 100%">
            ...
            <div style="margin: 3% 0">
              <el-table :data="newdataform.student" border style="width: 100%">
          ...
          <el-form-item label="指导老师" style="width: 100%">
            ...
            <div style="margin: 3% 0">
              <el-table :data="newdataform.teacher" border style="width: 100%">
                <el-table-column prop="name" label="姓名"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    savestuedit() {
      if (
        this.editstuItem.name == "" ||
        this.editstuItem.grade == "" ||
    ...
    savesTchedit() {
      if (
        this.editTchItem.name == "" ||
        this.editTchItem.job == "" ||
    ...
    savestuadd() {
      if (
        this.addstuItem.name == "" ||
        this.addstuItem.grade == "" ||
    ...
    getdata() {
      let that = this;
      this.$axios
        .get("/project/getbyId/" + this.$route.query.id)
        .then((res) => {
          this.newdataform.project = res.data.data.project;
